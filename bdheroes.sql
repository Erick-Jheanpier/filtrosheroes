...
DROP PROCEDURE IF EXISTS sp_get_superheroes;
DELIMITER $$

CREATE PROCEDURE sp_get_superheroes(IN p_publisher_id INT)
BEGIN
    SELECT 
    ...
    WHERE (p_publisher_id IS NULL OR p.id = p_publisher_id)
    LIMIT 100;
END$$
